...
function insertNewRecord(data) {
    ...
    cell7.innerHTML = `<a onClick="onEdit(this)" style="text-decoration: underline;color:blue">Edit</a>
                       <a onClick="onDelete(this)" style="text-decoration: underline;color:blue">Delete</a>`;
}
